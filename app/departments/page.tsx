...
export default function DepartmentsPage() {
  ...
  return <div className="space-y-6"><PageHeading eyebrow="People" title="Departments" description="Organize employees into clear teams and reporting groups." /><SectionTabs items={[{ href: "/employees", label: "Employees" }, { href: "/lifecycle", label: "Lifecycle" }, { href: "/departments", label: "Departments" }]} />
