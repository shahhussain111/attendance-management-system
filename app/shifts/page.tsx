...
import { Shift, formatMinutes, shiftDuration, weekDays } from "@/lib/scheduling";

type Values = Omit<Shift, "id" | "deletedAt">;
const blank: Values = { name: "", startTime: "09:00", endTime: "17:00", graceMinutes: 10, workingDays: [1, 2, 3, 4, 5], status: "Active" };
...
export default function ShiftsPage() {
  ...
  const openEdit = (shift: Shift) => { setValues({ name: shift.name, startTime: shift.startTime, endTime: shift.endTime, graceMinutes: shift.graceMinutes, workingDays: [...shift.workingDays], status: shift.status }); setEditingId(shift.id); setErrors({}); setFormOpen(true); };
